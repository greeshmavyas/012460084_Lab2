...
class ReactUploadRestImage extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  fileUploadHandler = () => {
    ...
    axios
      .post(
        "http://localhost:3001/grubhub/owner/restaurant/upload",
        formData,
        config
      )
      .then(response => {
        this.props.readRestFileName(response.data.fileName);
      ...
      <div className="container">
        <div className="row" style={{ width: "70%", marginLeft: "10%" }}>
          <div className="col-md-10 text-center border card-body">
            ...
            <h5> Upload an image of your restaurant</h5>
...
export default ReactUploadRestImage;
